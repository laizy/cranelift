...
pub trait InstBuilder<'f>: InstBuilderBase<'f> {
    ...
    /// - args: EBB arguments
    #[allow(non_snake_case)]
    fn br_icmp<T1: Into<ir::condcodes::IntCC>>(mut self, Cond: T1, x: ir::Value, y: ir::Value, EBB: ir::Ebb, args: &[Value]) -> Inst {
        let Cond = Cond.into();
    ...
    /// - args: EBB arguments
    #[allow(non_snake_case)]
    fn brif<T1: Into<ir::condcodes::IntCC>>(mut self, Cond: T1, f: ir::Value, EBB: ir::Ebb, args: &[Value]) -> Inst {
        let Cond = Cond.into();
        let mut vlist = ir::ValueList::default();
        {
            let pool = &mut self.data_flow_graph_mut().value_lists;
    ...
    /// - args: EBB arguments
    #[allow(non_snake_case)]
    fn brff<T1: Into<ir::condcodes::FloatCC>>(mut self, Cond: T1, f: ir::Value, EBB: ir::Ebb, args: &[Value]) -> Inst {
        let Cond = Cond.into();
        let mut vlist = ir::ValueList::default();
        {
            let pool = &mut self.data_flow_graph_mut().value_lists;
