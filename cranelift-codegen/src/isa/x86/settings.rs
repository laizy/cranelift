...
static HASH_TABLE: [u16; 32] = [
    0xffff, 0xffff, 0xffff, 0, 16, 0xffff, 12, 0xffff, 0xffff, 0xffff, 10, 0xffff, 0xffff, 3,
    0xffff, 7, 2, 6, 1, 11, 0xffff, 0xffff, 5, 4, 14, 0xffff, 15, 13, 0xffff, 0xffff, 8, 9,
];
...
//clude!(concat!(env!("OUT_DIR"), "/settings-x86.rs"));
